...
if($prev>=0)
echo '<a href="'.$_SERVER['PHP_SELF'].'?startrow='.$prev.'"><span style="color:white">Prev </span></a>';

if($return_rows==$limit)
echo '| <a href="'.$_SERVER['PHP_SELF'].'?startrow='.$next.'"><span style="color:white">Next </span></a>';
?>
</div>
