...
if($prev>=0)
echo '<a href="'.$_SERVER['PHP_SELF'].'?startrow='.$prev.'&catid='.$id.'"><font color=white>Previous</font></a>';

if($return_rows==$limit)
echo '| <a href="'.$_SERVER['PHP_SELF'].'?startrow='.$next.'&catid='.$id.'"><font color=white>Next</font></a>';
?>
</div>
