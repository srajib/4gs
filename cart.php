...
if($_SESSION['username']){echo "<form action=order_list.php method=post name=nextpage>";}
else{echo "<form action=main_login.php method=post name=nextpage>";}
	...
	</td><td>"; // <input type='submit' name='checkout_delivery' value='Proceed Checkout' />
...
/*
if($_SESSION['username']!='null'){echo "<a href=product_list.php>";}
else {echo "<a href=main_login.php>";}
