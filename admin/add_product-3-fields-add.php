...
<head>
<meta charset="utf-8">
<title>New Product | Genius Technology</title>
...
if(isset($_POST['submit']))
{
	...
	VALUES('$uid',$cat1,$cat2,'$name','$desc', '$model', '$sprinter', '$stav', '$quan',$price,$post_cost,$dis_price, '$dt', '$weight', '$size', '$warranty',".$_SESSION['admin_id'].")");	
