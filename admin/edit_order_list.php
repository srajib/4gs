...
if(isset($_POST['submit']))
{
	...
	if($result)
	{
		$con = "<b><font face='Arial, Helvetica, sans-serif' size='2' color='#006600'>Order saved successfully.</font></b>";
	}
	else
	{
		$con = "<b><font face='Arial, Helvetica, sans-serif' size='2' color='#FF0000'>Order could not be saved.</font></b>";
	}
}
else
{
			...
			<div class="span8">
	      		...
	      		<div id="horizontal" class="widget widget-form">
					...
					<?php echo $con; ?>						
						...
						<form class="form-horizontal" action="edit_order_list.php" method="post">
					        <fieldset>
					         
								<?php
								$sqlcat = mysql_query("SELECT * FROM order_list WHERE ord_id=$id");
...
<div class="controls">								
	<select name="ordstatus" id="input01" value="<?php echo $row2['ord_status']; ?>"> 
		...
		<option value="7" <?php if($x=='7'){ ?> selected="selected" <?php } ?> >Successfuly Received</option>		
		<option value="8" <?php if($x=='8'){ ?> selected="selected" <?php } ?> >Successfuly Stocked</option>		
