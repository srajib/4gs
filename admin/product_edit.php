	...
	<div class="container" style="margin:10px auto;">		
		<div id="page-title" class="clearfix">			
			<ul class="breadcrumb">
			  ...
			  <li class="active"><a href=add_product.php>Add New Product</a></li>
			</ul>			
		</div> <!-- /.page-title -->
	...
	{ 
     ...
     ?>
		...
		<div class="single" style="float:left;width=200">
			<a href="<?php echo $pic_loc['location']; ?>" rel="lightbox[plants]" title="Click on the left or right side of the image to move previous or forward."><img src="<?php echo $pic_loc['location']; ?>" style="width:160px;" title="image <?php echo $count; ?> 0f 4 thumb" /></a>
...
<div id="productdescription" style="height:auto;"> <!--style="float:left; margin-left:15px; width:350px; height:400px; color:#555; background-color:#FAFAFA; border:1px solid #EEE" -->

<center><table width="100%" class="itemdetails" style="float:left;padding-left: 5px;"">
...
<tr><td colspan="3"><div style="margin-bottom:5px; color:#C26D11; font-size:18px;">
<br>Title <input type="text" name="product_name" value="<?php echo $desc['product_name'];?>">
...
<tr><td>Price</td><td> : </td><td>$ <input type="text" style="width:45px" name="price" value="<?php echo $desc['price'];?>"> </td></tr>
...
<input type="text" name="size" style="width:70px" value="<?php echo $desc['size'];?>">
</td></tr>
<tr><td>Warranty</td><td> : </td><td>
<input type="text" name="warranty" style="width:45px" value="<?php echo $desc['warranty'];?>">
</td></tr>
<tr><td>Postage Cost</td><td> : </td><td>$ <input type="text" style="width:45px" name="postage_cost" value="<?php echo $desc['postage_cost'];?>"> </td></tr>
...
echo '</select></div></td></tr></table></center>';
