...
if(isset($_POST['submit']))
{
	...
	$dis_price=0.0;
	$sql1 = mysql_query("INSERT INTO product(unique_id, cat1_id, cat2_id, product_name, product_details, quantity, price,postage_cost, dis_price, date, weight, size, warranty,uploader_id) 
	VALUES('$uid',$cat1,$cat2,'$name','$desc','$quan',$price,$post_cost,$dis_price, '$dt', '$weight', '$size', '$warranty',".$_SESSION['admin_id'].")");	
