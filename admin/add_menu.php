...
<head>
<meta charset="utf-8">
<title>New Menu | Genius Technology Ltd</title>
...
if(isset($_POST['submit']))
{
	...
	*/
	...
	if($sql1)
	{
		$con .= "<b><font face='Arial, Helvetica, sans-serif' size='2' color='#060'> Menu saved successfully. :)</font></b>";
	}
	else
	{
		$con .= "<b><font face='Arial, Helvetica, sans-serif' size='2' color='#F00'> Menu could not be saved. :(</font></b>";
	}
}
else
{
...
<?php echo $con; ?>	
<form class="form-horizontal" enctype="multipart/form-data" action="add_menu.php" method="post">
<fieldset>
