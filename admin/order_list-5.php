...
?>                             
	<tr class="odd gradeX">
		...
		<td><?php if($row2['ord_status']=='0') { echo 'Pending';} else {echo 'Completed';}?></td>
		<td>
			<a href="order_details.php?ordid=<?php echo $row2['ord_id']; ?>">Details</a> | 
			<a href="<?php // echo row2['delete_order_list.php']; ?>">Edit</a>
		</td>
	</tr>
<?php
}
